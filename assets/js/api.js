const requestURL = 'https://api.unsplash.com/search/photos/?query=tea-leaves&client_id=QSz12piqsEZKwy7mseJIbTRYnc6SD1WgF91DNS7wp70';
...
get_image_button.addEventListener('click', async () => {
    ...
    image_to_display.scr = randomImage;
});
